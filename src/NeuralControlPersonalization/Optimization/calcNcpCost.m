...
[activationsWithMtpData, activationsWithoutMtpData] = ...
    ...
    inputs.mtpActivationColumnNames, inputs.muscleTendonColumnNames);
activationTracking = activationsWithMtpData - ...
    inputs.mtpActivation;
...
errs = 1 / sqrt(params.momentTrackingWeight + params.activationTrackingWeight + params.activationMinimizationWeight) * [momentTrackingError; activationTrackingError; activationMinimizationError];
cost = errs' * errs;
end
