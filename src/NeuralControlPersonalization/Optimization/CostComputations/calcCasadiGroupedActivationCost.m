...
%
% CasADi-safe equivalent of calcGroupedActivationCost.m, adapted for the
% 2-D activations2d layout [numTrials*numPoints x numMuscles] (muscle is
% a column here rather than the middle dimension of a 3-D array).
%
...
function cost = calcCasadiGroupedActivationCost(activations2d, params)
cost = [];
for i = 1:length(params.activationGroups)
    ...
    % CasADi MX does not implicitly broadcast a column vector against a
