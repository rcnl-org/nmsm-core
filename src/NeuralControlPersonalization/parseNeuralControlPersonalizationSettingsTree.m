...
if inputs.allow_negative_synergy_vector_weights
    % Internal cost term, keeps activations in [0,1]
    params.costTerms{end+1} = struct('type', "activation_bounds", ...
        'isEnabled', true, 'maxAllowableError', 0.05, 'errorCenter', 0);
end
...
params.useCasadi = getBooleanLogicFromField(getFieldByNameOrAlternate( ...
    tree, 'use_casadi', false));
end
