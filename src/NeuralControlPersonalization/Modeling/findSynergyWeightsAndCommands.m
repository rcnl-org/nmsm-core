...
for i = 1:length(inputs.synergyGroups)
    if i == 2 && i == length(inputs.synergyGroups) && ...
            inputs.enforceBilateralSymmetry
        for j = 1: inputs.synergyGroups{1}.numSynergies
            weights(row, column : column + ...
                length(inputs.synergyGroups{1}.muscleNames) - 1) = ...
