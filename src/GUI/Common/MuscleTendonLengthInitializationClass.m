...
classdef MuscleTendonLengthInitializationClass < handle
    ...
    properties (Constant)
        ...
        costTermStruct = struct( ...                                    % enabled, error center, max allowable error, uses error center
            'passive_joint_moment_tracking',                    {{'true'   0     2     false}}, ...
            'optimal_fiber_length_deviation',                   {{'true'   1     0.3   true}}, ...
            'tendon_slack_length_deviation',                    {{'true'   1     0.3   true}}, ...
            'minimum_normalized_fiber_length_deviation',        {{'true'   0     0.3   false}}, ...
            'maximum_normalized_fiber_length_deviation',        {{'true'   0     0.03  false}}, ...
            'maximum_muscle_stress_deviation',                  {{'true'   1.2   0.1   true}}, ...
            'passive_force_minimization',                       {{'false'  0     10    false}}, ...
            'grouped_normalized_fiber_length_similarity',       {{'false'  0     0.1   false}}, ...
            'grouped_maximum_normalized_fiber_length_similarity', {{'true' 0     0.1   false}} ...
            );
    end
