classdef MuscleTendonLengthInitializationClass < handle
    ...
    properties (Access = public, SetObservable)
        ...
        costTermStruct = struct( ...
                'passive_joint_moment',                             {{'true'   0     2}}, ...
                'optimal_muscle_fiber_length',                      {{'true'   1     0.3}}, ...
                'tendon_slack_length',                              {{'true'   1     0.3}}, ...
                'minimum_normalized_muscle_fiber_length',           {{'true'   0     0.3}}, ...
                'maximum_normalized_muscle_fiber_length',           {{'true'   0     0.03}}, ...
                'maximum_muscle_stress',                            {{'true'   1.2   0.1}}, ...
                'passive_muscle_force',                             {{'false'  0     10}}, ...
                'grouped_normalized_muscle_fiber_length',           {{'true'   0     0.1}}, ...
                'grouped_maximum_normalized_muscle_fiber_length',   {{'true'   0     0.1}} ...
                );
