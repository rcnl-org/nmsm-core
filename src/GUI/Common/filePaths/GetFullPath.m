...
%
% This function returns the absolute canonical path of a file or folder,
% resolving relative path elements such as "." and ".." and handling long
% Windows paths with the magic "\\?\" prefix.
%
% (string, string) -> (string)
% Returns the absolute canonical path of the given file or folder
