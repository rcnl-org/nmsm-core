...
%
% This class holds the GUI-side settings for the RCNLMuscleController used
...
% ----------------------------------------------------------------------- %
classdef RCNLMuscleControllerClass < handle
    ...
    methods
        function obj = RCNLMuscleControllerClass()
            obj.reset();
        end

        function reset(obj)
            obj.is_enabled = 'false';
            obj.muscle_list = string([]);
