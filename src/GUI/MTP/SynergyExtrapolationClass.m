...
classdef SynergyExtrapolationClass < handle
    ...
    properties (Constant)
        ...
        costTermStruct = struct( ...
            'inverse_dynamics_load_tracking_SynX',          {{'true'   0  2    false}}, ...
            'extrapolated_muscle_activation_minimization',  {{'true'   0  0.5  true}}, ...
            'residual_muscle_activation_minimization',      {{'true'   0  0.01 false}} ...
            );
    end
