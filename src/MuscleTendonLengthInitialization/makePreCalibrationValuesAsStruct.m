...
values.optimalFiberLengthScaleFactors = parameterChange(:, 1 : ...
    experimentalData.numMuscles);
values.tendonSlackLengthScaleFactors = ...
    parameterChange(:, experimentalData.numMuscles + 1 : 2 * ...
    experimentalData.numMuscles);
values.maxNormalizedFiberLength = ...
    parameterChange(:, 2 * experimentalData.numMuscles + 1 : 2 * ...
    experimentalData.numMuscles + ...
    experimentalData.numMusclePairs + ...
