...
function inputs = parseOptimalControlSolverSettings( ...
    tree, inputs)
inputs.solverType = lower(getTextFromField(getFieldByNameOrAlternate( ...
    tree, 'optimal_control_solver_type', 'gpops')));
assert(strcmp(inputs.solverType, 'gpops') || ...
    strcmp(inputs.solverType, 'casadi'), ...
    "Only GPOPS and CasADi are supported optimal control solver types.")
