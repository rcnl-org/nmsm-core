...
function [inverseDynamicsMoments, angularMomentum, metabolicCost, ...
    massCenterVelocity, bodyOrientations, bodyAngularVelocities, ...
    imuQuantities] = ...
    inverseDynamics( time, jointAngles, jointVelocities, ...
    jointAccelerations, coordinateLabels, appliedLoads, modelName, ...
    muscleActivations, bodyOrientationIndices, ...
    bodyAngularVelocityIndices, imuBodyIndices, imuLocations, ...
    computeAngularMomentum, computeMetabolicCost, computeBodyOrientation, ...
    computeBodyAngularVelocity, computeImuQuantities, version)
if isequal(mexext, 'mexw64')
    if version >= 40600
		[inverseDynamicsMoments, angularMomentum, metabolicCost, ...
            massCenterVelocity, bodyOrientations, bodyAngularVelocities, ...
            imuQuantities] = ...
            inverseDynamicsBasedModeledValuesMexWindows40600( ...
            time, jointAngles, jointVelocities, jointAccelerations, ...
            coordinateLabels, appliedLoads, muscleActivations, ...
            bodyOrientationIndices, bodyAngularVelocityIndices, ...
            imuBodyIndices, imuLocations, computeAngularMomentum, ...
            computeMetabolicCost, computeBodyOrientation, ...
            computeBodyAngularVelocity, computeImuQuantities);
	elseif version >= 40501
        [inverseDynamicsMoments, angularMomentum, metabolicCost, ...
            massCenterVelocity, bodyOrientations, bodyAngularVelocities, ...
            imuQuantities] = ...
            inverseDynamicsBasedModeledValuesMexWindows40501( ...
            time, jointAngles, jointVelocities, jointAccelerations, ...
            coordinateLabels, appliedLoads, muscleActivations, ...
            bodyOrientationIndices, bodyAngularVelocityIndices, ...
            imuBodyIndices, imuLocations, computeAngularMomentum, ...
        ...
        [inverseDynamicsMoments, angularMomentum, metabolicCost, ...
            massCenterVelocity, bodyOrientations, bodyAngularVelocities, ...
            imuQuantities] = ...
            inverseDynamicsBasedModeledValuesMexWindows40400( ...
            time, jointAngles, jointVelocities, jointAccelerations, ...
            coordinateLabels, appliedLoads, muscleActivations, ...
            bodyOrientationIndices, bodyAngularVelocityIndices, ...
            imuBodyIndices, imuLocations, computeAngularMomentum, ...
