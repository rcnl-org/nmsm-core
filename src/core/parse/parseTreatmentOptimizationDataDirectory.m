...
if any(inputs.controllerTypes(2:3))
    ...
    if inputs.useActivationDynamics
        try
            [experimentalMuscleExcitations, excitationLabels] = ...
                parseTrialData(inputs.initialGuessDirectory, ...
                strcat(inputs.trialName, "_combinedExcitations"), ...
                inputs.model);
            [missingMuscles, missingIndices] = setdiff( ...
                inputs.muscleLabels, excitationLabels);
            excitationLabels = [excitationLabels missingMuscles];
            experimentalMuscleExcitations = ...
                [experimentalMuscleExcitations ...
                zeros(size(experimentalMuscleExcitations, 1), ...
                length(missingMuscles))];
            [~, ~, newOrder] = intersect( ...
                inputs.muscleLabels, ...
                excitationLabels, 'stable');
            inputs.experimentalMuscleExcitations = ...
                experimentalMuscleExcitations(:, newOrder);
        catch
            warning("Could not find " + strcat(inputs.trialName, ...
                "_combinedExcitations.sto in the initial guess " + ...
                "directory of ", inputs.initialGuessDirectory, ...
                ". Setting initial excitations to match activations."));
            inputs.experimentalMuscleExcitations = ...
                inputs.experimentalMuscleActivations;
        end
    end
...
try
    ...
    if inputs.useJerk
        ...
        inputs.initialJerks = reorderInitialValues(inputs.initialJerks, ...
            inputs.initialJerkLabels, inputs.statesCoordinateNames, ...
