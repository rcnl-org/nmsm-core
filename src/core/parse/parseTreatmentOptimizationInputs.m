...
inputs.useControlDynamicsFilter = getBooleanLogicFromField( ...
    getFieldByNameOrAlternate(tree, 'use_first_order_control_dynamics_filter', false));
inputs.controlDynamicsFilterConstant = getDoubleFromField( ...
    getFieldByNameOrAlternate(tree, 'control_dynamics_filter_time_constant', 1));
inputs.useJerk = getBooleanLogicFromField( ...
    getFieldByNameOrAlternate(tree, 'use_jerk', false));
end
