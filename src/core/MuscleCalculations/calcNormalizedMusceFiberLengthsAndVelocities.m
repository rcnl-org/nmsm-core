...
scaledOptimalMuscleLength = permute(inputData.optimalMuscleLength .* ...
...
lMtilda = (inputData.lMt - onesCol .* scaledTendonSlackLength) ./ ...
    (onesCol .* (scaledOptimalMuscleLength .* ...
...
vMtilda = inputData.muscleTendonVelocity ./ ...
    (inputData.vMaxFactor * onesCol .* (scaledOptimalMuscleLength .* ...
    permute(cos(inputData.pennationAngle), [1 3 2])));
end
