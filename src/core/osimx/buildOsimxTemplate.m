...
function osimx = buildOsimxTemplate(osimxModelName, osimModelFileName)
osimx.NMSMPipelineDocument.Attributes.Version = "0.1.0";
osimx.NMSMPipelineDocument.OsimxModel.Attributes.name = osimxModelName;
