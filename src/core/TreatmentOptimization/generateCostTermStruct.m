...
costTermCalculations.coordinate_tracking = @(values, auxdata, costTerm) ...
...
costTermCalculations.controller_tracking = @(values, auxdata, costTerm) ...
...
costTermCalculations.joint_jerk_minimization = @(values, auxdata, costTerm) ...
...
costTermCalculations.user_defined = @(values, auxdata, costTerm) ...
    userDefinedFunction(values, auxdata, costTerm, costTermType);
