...
muscleExcitations = calcMuscleExcitations(time, EmgSplines, ...
    findCorrectMtpValues(1, valuesStruct), findCorrectMtpValues(4, ...
    valuesStruct));
neuralActivations = calcNeuralActivations(muscleExcitations, ...
    findCorrectMtpValues(2, valuesStruct), time);
