...
neuralActivations = calcNeuralActivations(muscleExcitations, ...
    findCorrectMtpValues(2, valuesStruct), inputData.emgTime, ...
    inputData.numPaddingFrames);
...
costs = calcLmTildaCurveChangesCost(lMtilda, ...
    inputData.normalizedFiberLengthExperimental, inputData.normalizedFiberLengthPairs, ...
...
costs = calcPairedMusclePenalties(valuesStruct, ...
    ...
    inputData.maxAllowableErrors, costs);
