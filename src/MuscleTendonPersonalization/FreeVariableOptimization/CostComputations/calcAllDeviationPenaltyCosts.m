...
cost.lMoPenalty = calcPenalizeDifferencesCostTerm( ...
    data.optimalMuscleLength .* findCorrectMtpValues(6, valuesStruct) ...
    - params.lMoNominal, params.errorCenters(4), ...
    params.maxAllowableErrors(4));
% Penalize difference of lTs values from pre-calibrated values
cost.lTsPenalty = calcPenalizeDifferencesCostTerm( ...
    data.tendonSlackLength .* findCorrectMtpValues(5, valuesStruct) ...
    - params.lTsNominal, params.errorCenters(5), ...
