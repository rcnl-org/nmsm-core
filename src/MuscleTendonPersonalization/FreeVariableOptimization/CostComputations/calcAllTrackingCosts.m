...
costNormalizedFiberLengthMeanPenalty = calcTrackingCostTerm(permute(mean(normalizedFiberLength, 2), ...
    [1 3 2]), permute(mean(params.normalizedFiberLengthExperimental,2), ...
    [1 3 2]), params.errorCenters(7), params.maxAllowableErrors(7));
costNormalizedFiberLengthShapePenalty = calcTrackingCostTerm( ...
    ...
    params.normalizedFiberLengthExperimental)), params.errorCenters(7), ...
