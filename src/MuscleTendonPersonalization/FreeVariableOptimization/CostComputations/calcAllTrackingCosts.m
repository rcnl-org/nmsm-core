...
costNormalizedFiberLengthMeanPenalty = calcTrackingCostTerm(permute(mean(normalizedFiberLength, 2), ...
    [1 3 2]), permute(mean(experimentalData.normalizedFiberLengthExperimental,2), ...
...
costNormalizedFiberLengthShapePenalty = calcTrackingCostTerm( ...
    ...
    experimentalData.normalizedFiberLengthExperimental)), experimentalData.errorCenters(7), ...
