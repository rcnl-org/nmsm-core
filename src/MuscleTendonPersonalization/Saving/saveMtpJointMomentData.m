...
if isfield(mtpInputs, "synergyExtrapolation")
    ...
    writeMtpDataToSto(mtpInputs.coordinateNames, mtpInputs.prefixes, ...
        resultsStruct.resultsSynxNoResiduals.muscleJointMoments, ...
        fullfile(resultsDirectory, "\modelJointMomentsSynxNoResiduals"), ...
        "_modelJointMomentsSynxNoResiduals.sto")
