...
writeMtpDataToSto(mtpInputs.coordinateNames, mtpInputs.prefixes, ...
    resultsStruct.results.muscleJointMoments, strcat(resultsDirectory, ...
    "\modelJointMoments"), "_modelJointMoments.sto")
if isfield(mtpInputs, "synergyExtrapolation")
    writeMtpDataToSto(mtpInputs.coordinateNames, mtpInputs.prefixes, ...
        resultsStruct.resultsSynx.muscleJointMoments, strcat(resultsDirectory, ...
        "\modelJointMomentsSynx"), "_modelJointMomentsSynx.sto")
    writeMtpDataToSto(mtpInputs.coordinateNames, mtpInputs.prefixes, ...
        resultsStruct.resultsSynxNoResiduals.muscleJointMoments, strcat(resultsDirectory, ...
