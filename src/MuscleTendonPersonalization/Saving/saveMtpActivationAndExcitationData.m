...
if isfield(mtpInputs, "synergyExtrapolation")
    ...
    writeMtpDataToSto(mtpInputs.muscleNames, mtpInputs.prefixes, ...
        resultsStruct.resultsSynxNoResiduals.muscleExcitations, ...
        fullfile(resultsDirectory, "muscleExcitationsSynxNoResiduals"), ...
        "_muscleExcitationsSynxNoResiduals.sto")

    writeMtpDataToSto(mtpInputs.muscleNames, mtpInputs.prefixes, ...
        resultsStruct.resultsSynxNoResiduals.muscleActivations, ...
        fullfile(resultsDirectory, "muscleActivationsSynxNoResiduals"), ...
        "_muscleActivationsSynxNoResiduals.sto")
