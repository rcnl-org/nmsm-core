...
function cost = calcMuscleActivationFromSynergyCost(modeledValues, ...
    experimentalData, params)
costWeight = valueOrAlternate(params, ...
    "muscleActivationsFromSynergyCostWeight", 1);
errorCenter = valueOrAlternate(params, ...
    "muscleActivationsFromSynergyErrorCenter", 0);
maximumAllowableError = valueOrAlternate(params, ...
    "muscleActivationsFromSynergyeMaximumAllowableError", 0.3);

cost = costWeight * calcDeviationCostTerm(...
    modeledValues.muscleActivations(:, ...
    [experimentalData.synergyExtrapolation.missingEmgChannelPairs{:}], ...
