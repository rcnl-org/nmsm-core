...
costWeight = valueOrAlternate(params, ...
    "electromechanicalDelayGroupedSimilarityCostWeight", 1);
errorCenter = valueOrAlternate(params, ...
    "electromechanicalDelayGroupedSimilarityErrorCenter", 0);
maximumAllowableError = valueOrAlternate(params, ...
    "electromechanicalDelayGroupedSimilarityMaximumAllowableError", 0.2);
