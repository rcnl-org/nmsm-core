...
totalCost = calcMomentTrackingCost(synxModeledValues, experimentalData, ...
    params);
totalCost = totalCost + calcMomentTrackingNoSynxCost(modeledValues, ...
    experimentalData, params);
...
totalCost = totalCost + calcNormalizedFiberLengthPairedSimilarityCost( ...
    synxModeledValues, experimentalData, params);
totalCost = totalCost + calcEmgScaleFactorPairedSimilarityCost(values, ...
    experimentalData, params);
...
totalCost = totalCost + calcMuscleActivationFromSynergyCost( ...
    synxModeledValues, experimentalData, params);
totalCost = totalCost + calcMuscleActivationFromResidualsCost( ...
