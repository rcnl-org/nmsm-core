...
costTermFieldNames = [...
    ...
    "groupedEmgScaleFactor", ...
    "groupedElectromechanicalDelay", ...
    ];
costTermTypes = [...
...
output.costTerms = parseRcnlCostTermSet(tree, costTermFieldNames, costTermTypes);
end
...
costTermFieldNames = [
    "measuredInverseDynamicsJointMoment", ...
    "extrapolatedMuscleActivation", ...
    "residualMuscleActivation", ...
    ];
costTermTypes = [
...
synergyExtrapolation = parseRcnlCostTermSet(synergyExtrapolationTree, ...
    synergyExtrapolation, costTermFieldNames, costTermTypes);
end
