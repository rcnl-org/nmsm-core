...
output.isIncluded(1) = parseElementBoolean(tree, ...
    "optimize_electromechanical_delays");
output.isIncluded(2) = parseElementBoolean(tree, ...
    "optimize_activation_time_constants");
output.isIncluded(3) = parseElementBoolean(tree, ...
    "optimize_activation_nonlinearity_constants");
output.isIncluded(4) = parseElementBoolean(tree, ...
    "optimize_emg_scale_factors");
output.isIncluded(5) = parseElementBoolean(tree, ...
    "optimize_optimal_fiber_lengths");
output.isIncluded(6) = parseElementBoolean(tree, ...
