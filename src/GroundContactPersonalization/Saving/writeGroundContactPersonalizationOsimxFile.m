...
for task = 1:length(inputs.tasks)
    GCP.OpenSimDocument.OsimxModel.GCPFootList.GCPFoot{task}. ...
        Attributes.name = convertStringsToChars("Foot_" + task);
    GCP.OpenSimDocument.OsimxModel.GCPFootList.GCPFoot{task}. ...
        index.Comment = 'Index of foot';
    GCP.OpenSimDocument.OsimxModel.GCPFootList.GCPFoot{task}. ...
        index.Text = num2str(task);
    GCP.OpenSimDocument.OsimxModel.GCPFootList.GCPFoot{task}. ...
