...
function [horizontalGrfX, horizontalGrfZ] = ...
...
for i=1:length(values.springConstants)
    ...
    verticalGrf = 0;
    if (height-values.springRestingLength)<0
        verticalGrf = (values.springConstants(i) * ...
            (height - values.springRestingLength) * ...
    ...
    horizontalGrfX = horizontalGrfX + -verticalGrf * ...
        effectiveFrictionCoefficient * xVelocity;
    horizontalGrfZ = horizontalGrfZ + -verticalGrf * ...
