...
if isequal(mexext, 'mexw64')
    modelFile = sprintf('footModel_%i.osim', foot);
    % Use evalc to suppress output
    if inputs.osimVersion >= 40501
        evalc('pointKinematicsMexWindows40501(modelFile);');
    else
        evalc('pointKinematicsMexWindows40400(modelFile);');
    end
else
...
if version >= 40501
    [pointPositions, pointVelocities] = ...
        pointKinematicsMexWindows40501(surface.time', jointAngles', ...
        jointVelocities', surface.footMarkerLocations', ...
        surface.footMarkerBodies, surface.coordinateLabels);
else
    [pointPositions, pointVelocities] = ...
        pointKinematicsMexWindows40400(surface.time', jointAngles', ...
        jointVelocities', surface.footMarkerLocations', ...
        surface.footMarkerBodies, surface.coordinateLabels);
end
...
if version >= 40501
    [markerPositions, markerVelocities] = ...
        ...
        surface.springMarkerBodies, surface.coordinateLabels);
else
    [markerPositions, markerVelocities] = ...
        pointKinematicsMexWindows40400(surface.time', jointAngles', ...
        jointVelocities', surface.springMarkerLocations', ...
