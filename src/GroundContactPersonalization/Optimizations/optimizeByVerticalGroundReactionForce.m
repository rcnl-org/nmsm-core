...
% initialValues = [initialValues inputs.springConstants / 1000];
initialValues = [inputs.springConstants / 1000 inputs.dampingFactors * 1000];
...
fieldNameOrder = ["springConstants", "dampingFactors", "restingSpringLength"];
end
