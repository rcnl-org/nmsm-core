...
valueErrors(1, :) = abs(inputs.experimentalGroundReactionForces(1, :) -...
    modeledValues.anteriorGrf);
slopeErrors(1, :) = abs(inputs.experimentalGroundReactionForcesSlope(...
    1, :) - calcBSplineDerivative(inputs.time, ...
    modeledValues.anteriorGrf, 2, 25));
valueErrors(2, :) = abs(inputs.experimentalGroundReactionForces(2, :) -...
    modeledValues.verticalGrf);
slopeErrors(2, :) = abs(inputs.experimentalGroundReactionForcesSlope(...
    2, :) - calcBSplineDerivative(inputs.time, ...
    modeledValues.verticalGrf, 2, 25));
valueErrors(3, :) = abs(inputs.experimentalGroundReactionForces(3, :) -...
    modeledValues.lateralGrf);
slopeErrors(3, :) = abs(inputs.experimentalGroundReactionForcesSlope(...
