...
newValues = inputs.experimentalMarkerPositions.(markerFieldNames{i}) - ...
    modeledValues.markerPositions.(markerFieldNames{i});
newSlope = inputs.experimentalMarkerVelocities.(markerFieldNames{i}) - ...
    modeledValues.markerVelocities.(markerFieldNames{i});
