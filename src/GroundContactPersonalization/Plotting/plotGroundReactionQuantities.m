...
subplot(2, 3, 1)
plot(inputs.time, ...
    inputs.experimentalGroundReactionForces(2, :), "red", "LineWidth", 2)
hold on
plot(inputs.time, modeledValues.verticalGrf, "blue", "LineWidth", 2)
...
for i = 2:6
    ...
    if (i == 2)
        plot(inputs.time, ...
            ...
            "LineWidth", 2)
        hold on
        plot(inputs.time, modeledValues.(groundReactions(i)), ...
            "blue", "LineWidth", 2)
