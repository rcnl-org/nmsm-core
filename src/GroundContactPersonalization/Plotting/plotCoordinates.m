...
% calcn_r has no parent?
% coordinates = getCoordinatesFromBodies(model, ...
%     [inputs.toesBodyName inputs.hindfootBodyName]);
coordinates = ["mtp_r", "xRotation", "yRotation", "zRotation", ...
