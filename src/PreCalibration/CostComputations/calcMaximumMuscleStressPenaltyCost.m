...
function cost = calcMaximumMuscleStressPenaltyCost(values, params)
costWeight = valueOrAlternate(params, ...
    "maximumMuscleStressPenaltyCostWeight", 1);
errorCenter = valueOrAlternate(params, ...
    "maximumMuscleStressPenaltyErrorCenter", 1.2);
maximumAllowableError = valueOrAlternate(params, ...
    "maximumMuscleStressPenaltyMaximumAllowableError", 0.1);
