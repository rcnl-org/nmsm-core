...
% returns the modeled values for the given inputs for PreCalibration
...
function modeledValues = calcPreCalibrationModeledValues(values, ...
    experimentalData)
...
experimentalData.muscleTendonLength = ...
    experimentalData.gaitData.muscleTendonLength;
...
experimentalData.muscleTendonLength = ...
    experimentalData.passiveData.muscleTendonLength;
