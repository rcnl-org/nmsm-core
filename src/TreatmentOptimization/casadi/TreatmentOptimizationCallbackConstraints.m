classdef TreatmentOptimizationCallbackConstraints < casadi.Callback
    properties
        inputs
    ...
    methods
        ...
        function self = TreatmentOptimizationCallbackConstraints(name, inputs, ...
        ...
        function output = eval(self, casadiValues)
            ...
            outputs = computeCasadiFiniteDifferenceModelFunction( ...
                structValues, self.inputs, true, false);

            output = {outputs.path, outputs.terminal};
        end
    end
end
