    ...
    switch toolName
        case "TrackingOptimization"
            allowedTypes = [ ...
                ...
                "inverse_dynamics_load_smoothing", ...
...
costTermCalculations.generalized_coordinate_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcSmoothingCoordinateIntegrand( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    values.positions, ...
...
costTermCalculations.generalized_speed_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcSmoothingSpeedIntegrand( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    values.velocities, ...
...
costTermCalculations.generalized_acceleration_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcSmoothingAccelerationIntegrand( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    values.accelerations, ...
...
costTermCalculations.controller_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcSmoothingControllerIntegrand( ...
    costTerm, ...
    auxdata, ...
    values, ...
    values.time, ...
...
costTermCalculations.inverse_dynamics_load_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcSmoothingInverseDynamicsLoadIntegrand( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    modeledValues.inverseDynamicsMoments, ...
