...
function [costTermCalculations, allowedTypes, supportAD, termMetadata] = ...
    generateCostTermStruct(costTermType, controllerTypes, toolName)
[allowedTypes, supportAD, termMetadata] = getAllowedTypes(costTermType, ...
...
function [allowedTypes, supportAD, termMetadata] = getAllowedTypes( ...
    costTermType, controllerTypes, toolName)
if strcmp(costTermType, "continuous")
    costTermSet = { ...
        ...
        % Uses error center, Other allowed parameters
        {"generalized_coordinate_tracking",       [1, 1, 1], [1, 1, 1, 1], 1, "coordinate_list",    0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"generalized_speed_tracking",            [1, 1, 1], [1, 1, 1, 1], 1, "coordinate_list",    0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"generalized_acceleration_tracking",     [1, 1, 1], [1, 1, 1, 1], 1, "coordinate_list",    0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"generalized_acceleration_minimization", [1, 1, 1], [1, 1, 1, 1], 1, "coordinate_list",    0, "normalize_by_final_time"}, ...
        {"marker_position_tracking",              [1, 1, 1], [1, 1, 1, 1], 0, "marker_list",        0, ["axes", "normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"marker_velocity_tracking",              [1, 1, 1], [1, 1, 1, 1], 0, "marker_list",        0, ["axes", "normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"body_orientation_tracking",             [1, 1, 1], [1, 1, 1, 1], 0, "body_list",          0, ["axes", "sequence", "normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"body_orientation_minimization",         [1, 0, 1], [1, 1, 1, 1], 0, "body_list",          1, ["axes", "sequence", "normalize_by_final_time"]}, ...
        {"body_angular_velocity_tracking",        [1, 1, 1], [1, 1, 1, 1], 0, "body_list",          0, ["axes", "sequence", "normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"body_angular_velocity_minimization",    [1, 0, 1], [1, 1, 1, 1], 0, "body_list",          1, ["axes", "sequence", "normalize_by_final_time"]}, ...
        {"inverse_dynamics_load_tracking",        [1, 0, 1], [1, 1, 1, 1], 0, "load_list",          0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"inverse_dynamics_load_minimization",    [1, 0, 1], [1, 1, 1, 1], 0, "load_list",          0, "normalize_by_final_time"}, ...
        {"inverse_dynamics_slope_tracking",       [1, 0, 1], [1, 1, 1, 1], 0, "load_list",          0, "normalize_by_final_time"}, ...
        {"external_force_tracking",               [1, 0, 1], [1, 1, 1, 1], 0, "force_list",         0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"external_moment_tracking",              [1, 0, 1], [1, 1, 1, 1], 0, "moment_list",        0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"center_of_pressure_tracking",           [1, 0, 1], [1, 1, 1, 1], 0, "hindfoot_body_list", 0, ["axes", "time_ranges", "normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"muscle_activation_tracking",            [1, 0, 1], [0, 1, 1, 0], 1, "muscle_list",        0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"muscle_activation_minimization",        [1, 0, 1], [0, 1, 1, 0], 1, "muscle_list",        0, ["exponent", "normalize_by_final_time"]}, ...
        {"muscle_activation_shape_tracking",      [1, 0, 1], [0, 1, 1, 0], 1, "muscle_list",        0, "normalize_by_final_time"}, ...
        {"controller_tracking",                   [1, 1, 1], [1, 1, 1, 1], 1, "controller_list",    0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"controller_load_tracking",              [1, 1, 1], [1, 1, 1, 1], 1, "load_list",          0, ["normalize_by_final_time", "use_relative_error", "min_reference_value"]}, ...
        {"controller_minimization",               [1, 0, 1], [1, 1, 1, 1], 1, "controller_list",    0, ["exponent", "normalize_by_final_time"]}, ...
        {"controller_slope_minimization",         [1, 0, 1], [1, 1, 1, 1], 0, "controller_list",    0, "normalize_by_final_time"}, ...
        {"controller_shape_tracking",             [0, 0, 1], [1, 1, 1, 1], 1, "controller_list",    0, "normalize_by_final_time"}, ...
        {"joint_energy_generation_goal",          [0, 0, 1], [1, 1, 1, 1], 0, "load_list",          1, "normalize_by_final_time"}, ...
        {"joint_energy_absorption_goal",          [0, 0, 1], [1, 1, 1, 1], 0, "load_list",          1, "normalize_by_final_time"}, ...
        {"inverse_dynamics_shape_tracking",       [0, 0, 1], [1, 1, 1, 1], 0, "load_list",          0, "normalize_by_final_time"}, ...
        {"angular_momentum_minimization",         [0, 0, 1], [1, 1, 1, 1], 0, "",                   0, ["axes", "normalize_by_final_time"]}, ...
        {"user_defined",                          [1, 1, 1], [1, 1, 1, 1], 0, "",                   0, ["function_name", "cost_term_type"]}, ...
    };
elseif strcmp(costTermType, "discrete")
    costTermSet = { ...
        ...
        % Component list element ("" if the term takes no list),
        % Uses error center, Other allowed parameters
        {"synergy_vector_tracking",              [1, 0, 1], [0, 1, 0, 0], 1, "synergy_list",       0, string([])}, ...
        {"synergy_vector_symmetry",              [1, 0, 1], [0, 1, 0, 0], 1, "",                   0, "synergies"}, ...
        {"relative_walking_speed_goal",          [0, 0, 1], [1, 1, 1, 1], 0, "",                   1, string([])}, ...
        {"absolute_metabolic_cost_per_time",     [0, 0, 1], [0, 1, 1, 0], 1, "",                   1, string([])}, ...
        {"absolute_metabolic_cost_per_distance", [0, 0, 1], [0, 1, 1, 0], 0, "",                   1, string([])}, ...
        {"relative_metabolic_cost_per_time",     [0, 0, 1], [0, 1, 1, 0], 1, "",                   1, string([])}, ...
        {"relative_metabolic_cost_per_distance", [0, 0, 1], [0, 1, 1, 0], 0, "",                   1, string([])}, ...
        {"propulsive_impulse_goal",              [0, 0, 1], [1, 1, 1, 1], 0, "hindfoot_body_list", 1, string([])}, ...
        {"braking_impulse_goal",                 [0, 0, 1], [1, 1, 1, 1], 0, "hindfoot_body_list", 1, string([])}, ...
        {"user_defined",                         [1, 1, 1], [1, 1, 1, 1], 0, "",                   0, ["function_name", "cost_term_type"]}, ...
    };
else
...
allowedTypes = string([]);
supportAD = [];
termMetadata = struct('type', {}, 'componentElement', {}, ...
...
for term = costTermSet
    ...
    if any(toolNameLogical & currentTerm{2}) && any(controllerTypes & currentTerm{3})
        ...
        termMetadata(end + 1) = struct( ...
            ...
            'usesErrorCenter', logical(currentTerm{6}), ...
            'miscParams', currentTerm(7));
    end
end
end
...
costTermCalculations.controller_load_tracking = @(values, modeledValues, auxdata, costTerm) ...
...
costTermCalculations.body_angular_velocity_tracking = @(values, modeledValues, auxdata, costTerm) ...
    calcTrackingBodyAngularVelocityIntegrand( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
...
costTermCalculations.body_angular_velocity_minimization = @(values, modeledValues, auxdata, costTerm) ...
    calcMinimizingBodyAngularVelocityIntegrand( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    modeledValues.bodyAngularVelocities ...
...
costTermCalculations.external_force_tracking = @(values, modeledValues, auxdata, costTerm) ...
    ...
    values.time, ...
    getGroundReactionTermLabel(costTerm, 'force'));
...
costTermCalculations.external_moment_tracking = @(values, modeledValues, auxdata, costTerm) ...
    ...
    values.time, ...
    getGroundReactionTermLabel(costTerm, 'moment'));
...
costTermCalculations.muscle_activation_shape_tracking = @(values, modeledValues, auxdata, costTerm) ...
    calcTrackingMuscleActivationShapeIntegrand( ...
    costTerm, ...
    modeledValues.muscleActivations, ...
    values.time, ...
    auxdata, ...
