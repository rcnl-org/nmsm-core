...
if strcmp(costTermType, "continuous")
    costTermSet = { ...
        ...
        {"generalized_coordinate_tracking",       [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_speed_tracking",            [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_acceleration_tracking",     [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_acceleration_minimization", [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_position_tracking",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_velocity_tracking",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"body_orientation_tracking",             [1, 1, 1], [1, 1, 1, 1]}, ...
        {"body_orientation_minimization",         [1, 0, 1], [1, 1, 1, 1]}, ...
        {"inverse_dynamics_load_tracking",        [1, 0, 1], [1, 1, 1, 1]}, ...
        {"inverse_dynamics_load_minimization",    [1, 0, 1], [1, 1, 1, 1]}, ...
        {"inverse_dynamics_slope_tracking",       [1, 0, 1], [1, 1, 1, 1]}, ...
        {"external_force_tracking",               [1, 0, 1], [1, 1, 1, 1]}, ...
        {"external_moment_tracking",              [1, 0, 1], [1, 1, 1, 1]}, ...
        {"center_of_pressure_tracking",           [1, 0, 1], [1, 1, 1, 1]}, ...
        {"muscle_activation_tracking",            [1, 0, 1], [0, 1, 1, 0]}, ...
        {"muscle_activation_minimization",        [1, 0, 1], [0, 1, 1, 0]}, ...
        {"controller_tracking",                   [1, 1, 1], [1, 1, 1, 1]}, ...
        {"controller_minimization",               [1, 0, 1], [1, 1, 1, 1]}, ...
        {"controller_slope_minimization",         [1, 0, 1], [1, 1, 1, 1]}, ...
        {"controller_shape_tracking",             [0, 0, 1], [1, 1, 1, 1]}, ...
        {"joint_energy_generation_goal",          [0, 0, 1], [1, 1, 1, 1]}, ...
        {"joint_energy_absorption_goal",          [0, 0, 1], [1, 1, 1, 1]}, ...
        {"inverse_dynamics_shape_tracking",       [0, 0, 1], [1, 1, 1, 1]}, ...
        {"angular_momentum_minimization",         [0, 0, 1], [1, 1, 1, 1]}, ...
...
elseif strcmp(costTermType, "discrete")
    costTermSet = { ...
        % Table with the columns:
        % Name, Supported Tools (TO, VO, DO), Supported Controllers (Torque, Synergy, Muscle, User-Defined)
        {"synergy_vector_tracking",              [1, 0, 1], [0, 1, 0, 0]}, ...
        {"relative_walking_speed_goal",          [0, 0, 1], [1, 1, 1, 1]}, ...
        {"absolute_metabolic_cost_per_time",     [0, 0, 1], [0, 1, 1, 0]}, ...
        {"absolute_metabolic_cost_per_distance", [0, 0, 1], [0, 1, 1, 0]}, ...
        {"relative_metabolic_cost_per_time",     [0, 0, 1], [0, 1, 1, 0]}, ...
        {"relative_metabolic_cost_per_distance", [0, 0, 1], [0, 1, 1, 0]}, ...
        {"propulsive_impulse_goal",              [0, 0, 1], [1, 1, 1, 1]}, ...
        {"braking_impulse_goal",                 [0, 0, 1], [1, 1, 1, 1]}, ...
        {"user_defined",                         [1, 1, 1], [1, 1, 1, 1]}, ...
    };
