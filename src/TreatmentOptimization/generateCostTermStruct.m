...
if strcmp(costTermType, "continuous")
    costTermSet = { ...
        ...
        {"imu_linear_acceleration_tracking",      [1, 1, 1], [1, 1, 1, 1], 0}, ...
        {"imu_angular_velocity_tracking",         [1, 1, 1], [1, 1, 1, 1], 0}, ...
...
costTermCalculations.imu_linear_acceleration_tracking = @(values, modeledValues, auxdata, costTerm) ...
    calcTrackingImuLinearAccelerationIntegrand( ...
    modeledValues.imuQuantities, ...
    values.time, ...
    auxdata, ...
    costTerm);

costTermCalculations.imu_angular_velocity_tracking = @(values, modeledValues, auxdata, costTerm) ...
    calcTrackingImuAngularVelocityIntegrand( ...
    modeledValues.imuQuantities, ...
    values.time, ...
    auxdata, ...
    costTerm);
