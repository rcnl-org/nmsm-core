...
if strcmp(costTermType, "continuous")
    costTermSet = { ...
        ...
        {"body_angular_velocity_tracking",           [1, 1, 1], [1, 1, 1, 1], 0}, ...
        {"body_angular_velocity_minimization",       [1, 0, 1], [1, 1, 1, 1], 0}, ...
        ...
        {"muscle_activation_shape_tracking",         [1, 0, 1], [0, 1, 1, 0], 1}, ...
        {"controller_tracking",                      [1, 1, 1], [1, 1, 1, 1], 1}, ...
        {"controller_load_tracking",                 [1, 1, 1], [1, 1, 1, 1], 1}, ...
        ...
        {"converted_fd_continous_cost_minimization", [1, 1, 1], [1, 1, 1, 1], 1}, ...
    };
...
elseif strcmp(costTermType, "discrete")
    costTermSet = { ...
        ...
        {"relative_walking_speed_goal",             [1, 0, 1], [1, 1, 1, 1], 0}, ...
        {"absolute_metabolic_cost_per_time",        [1, 0, 1], [0, 1, 1, 0], 1}, ...
        {"absolute_metabolic_cost_per_distance",    [1, 0, 1], [0, 1, 1, 0], 0}, ...
        {"relative_metabolic_cost_per_time",        [1, 0, 1], [0, 1, 1, 0], 1}, ...
        {"relative_metabolic_cost_per_distance",    [1, 0, 1], [0, 1, 1, 0], 0}, ...
        {"propulsive_impulse_goal",                 [1, 0, 1], [1, 1, 1, 1], 0}, ...
        {"braking_impulse_goal",                    [1, 0, 1], [1, 1, 1, 1], 0}, ...
        {"user_defined",                            [1, 1, 1], [1, 1, 1, 1], 0}, ...
        {"converted_fd_discrete_cost_minimization", [1, 1, 1], [1, 1, 1, 1], 1}, ...
    };
...
costTermCalculations.converted_fd_continous_cost_minimization = @(values, modeledValues, auxdata, costTerm) ...
    calcConvertedFdContinuousCostTermMinimization(...
    values, ...
    costTerm);

costTermCalculations.converted_fd_discrete_cost_minimization = @(values, modeledValues, auxdata, costTerm) ...
    calcConvertedFdDiscreteCostTermMinimization(...
    values, ...
    costTerm);
