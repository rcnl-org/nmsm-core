...
if strcmp(costTermType, "continuous")
    costTermSet = { ...
        ...
        {"generalized_jerk_tracking",             [1, 1, 1], [1, 1, 1, 1], 1}, ...
        {"generalized_jerk_minimization",         [1, 1, 1], [1, 1, 1, 1], 1}, ...
...
costTermCalculations.generalized_jerk_tracking = @(values, modeledValues, auxdata, costTerm) ...
    calcTrackingJerkIntegrand( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    values.jerks, ...
...
costTermCalculations.generalized_jerk_minimization = @(values, modeledValues, auxdata, costTerm) ...
