...
%
% If the model is synergy driven, this function evaluates the difference
...
function constraint = calcControllerSmoothingPathConstraint(costTerm, inputs, ...
