...
function [pathConstraint, constraintTerm] = ...
    ...
    constraintTerm, inputs, time, velocities, coordinateName)
[velocity, constraintTerm] = findDataByLabels(constraintTerm, velocities, ...
...
fit = fitSmoothingTermCurve(inputs, time, velocity, ...
    polynomialDegree, harmonics);

pathConstraint = velocity - fit;
