...
function pathTerm = calcGeneralizedAccelerationDeviationPathConstraint( ...
...
pathTerm = calcTrackingCostArrayTerm(accelerations, ...
    experimentalJointAccelerations, indx);
end
