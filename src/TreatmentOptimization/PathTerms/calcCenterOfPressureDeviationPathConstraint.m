...
experimentalCenterOfPressure = ...
    findSplinedCenterOfPressureByLabels(constraintTerm, inputs, time);
experimentalCenterOfPressure = applyTermOffset(constraintTerm, ...
    experimentalCenterOfPressure);

centerOfPressure = calcCenterOfPressureForTermAxis( ...
    constraintTerm, forces, moments, points);

pathTerm = centerOfPressure - experimentalCenterOfPressure;
...
[pathTerm, constraintTerm] = applyPercentErrorWithMinimum(pathTerm, ...
    experimentalCenterOfPressure, constraintTerm);
end
