...
function cost = calcMinimizingKineticInconsistencyIntegrand(costTerm, ...
    inputs, time, modeledValues, torqueControls, loadName)
normalizeByFinalTime = valueOrAlternate(costTerm, ...
    "normalize_by_final_time", true);
cost = calcKineticPathConstraint(inputs, modeledValues, torqueControls, ...
    loadName);
