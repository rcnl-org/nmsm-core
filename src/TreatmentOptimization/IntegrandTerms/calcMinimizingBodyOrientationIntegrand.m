...
% Minimizes body orientation from error center.
...
function [cost, costTerm] = calcMinimizingBodyOrientationIntegrand( ...
    costTerm, inputs, time, bodyOrientations)
defaultTimeNormalization = true;
[time, costTerm] = normalizeTimeColumn(costTerm, inputs, time, ...
    defaultTimeNormalization);

[angles, costTerm] = findBodyAxesByLabels(costTerm, bodyOrientations, ...
