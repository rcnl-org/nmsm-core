...
function path = calcGpopsConstraint(constraintTermCalculations, ...
    allowedTypes, values, modeledValues, inputs)
path = [];
...
path = scaleToBounds(path, inputs.maxPath, inputs.minPath);
end
