...
% different time ranges. The 'splined' variables are evaluations of those
% splines at predetermined collocation times, which will be referenced for
% speed.
...
if setup.auxdata.useJerk
    setup.auxdata.splinedJointJerks = evaluateGcvSplines(setup.auxdata.splineJointAngles, ...
        setup.auxdata.coordinateNames, time, 3);
end
...
if isfield(setup.auxdata, 'splineBodyAngularVelocities')
    setup.auxdata.splinedBodyAngularVelocities = evaluateGcvSplines( ...
        setup.auxdata.splineBodyAngularVelocities, ...
        setup.auxdata.splineBodyAngularVelocitiesLabels, time, 0);
end
