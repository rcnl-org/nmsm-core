...
if inputs.controllerTypes(3)
    ...
    if inputs.useControlDynamicsFilter && ~isfield(inputs, ...
            'initialMuscleControlDerivatives')
        if strcmp(inputs.solverType, 'casadi')
            inputs.initialMuscleControlDerivatives = evaluateGcvSplines( ...
                inputs.splineMuscleControls, ...
                inputs.initialMuscleControlsLabels, ...
