...
elseif all(size(time) == size(inputs.collocationTimeOriginalWithEnd)) &&...
    ...
    experimentalForces = ...
        inputs.splinedGroundReactionForces{contactSurfaceIndices};
    experimentalForces(end + 1, :) = inputs.contactSurfaces{ ...
        contactSurfaceIndices}.experimentalGroundReactionForces(end, :);
    experimentalMoments = ...
        inputs.splinedGroundReactionMoments{contactSurfaceIndices};
    experimentalMoments(end + 1, :) = inputs.contactSurfaces{ ...
        contactSurfaceIndices}.experimentalGroundReactionMoments(end, :);
