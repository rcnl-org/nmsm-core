...
function experimentalGroundReactions = ...
    findSplinedGroundReactionForcesByLabels(term, inputs, time)
...
for i = 1 : length(groundReactionIndices)
    if all(size(time) == size(inputs.collocationTimeOriginal)) && ...
        ...
        groundReactions = ...
            inputs.splinedGroundReactionForces{contactSurfaceIndices(i)};
    ...
    elseif all(size(time) == size(inputs.collocationTimeOriginalWithEnd)) && ...
        ...
        groundReactions = ...
            inputs.splinedGroundReactionForces{contactSurfaceIndices(i)};
        experimentalGroundReactions(1 : end - 1, i) = ...
            groundReactions(:, groundReactionIndices(i));
        groundReactions = ...
            inputs.contactSurfaces{ ...
            contactSurfaceIndices(i)}.experimentalGroundReactionForces;
        experimentalGroundReactions(end, i) = groundReactions(end, ...
            groundReactionIndices(i));
