...
if strcmp(constraintTermType, "path")
    constraintTermSet = { ...
        ...
        {"converted_fd_continuous_cost_path",  [1, 1, 1], [1, 1, 1, 1], 0}, ...
    };
...
elseif strcmp(constraintTermType, "terminal")
    constraintTermSet = { ...
        ...
        {"user_defined",                               [1, 1, 1], [1, 1, 1, 1], 0}, ...
        {"converted_fd_discrete_cost_terminal",        [1, 1, 1], [1, 1, 1, 1], 0}, ...
    };
...
constraintTermCalculations.converted_fd_continuous_cost_path = @(values, modeledValues, auxdata, constraintTerm) ...
    calcConvertedFdContinuousCostTermConstraint(...
    values, ...
    modeledValues, ...
    auxdata, ...
    constraintTerm);

constraintTermCalculations.converted_fd_discrete_cost_terminal = @(values, modeledValues, auxdata, constraintTerm) ...
    calcConvertedFdDiscreteCostTermConstraint(...
    values, ...
    modeledValues, ...
    auxdata, ...
    constraintTerm);
