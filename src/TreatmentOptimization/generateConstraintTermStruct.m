...
if strcmp(constraintTermType, "path")
    constraintTermSet = { ...
        ...
        % Name, Supported Tools (TO, VO, DO), Supported Controllers (Torque, Synergy, Muscle, User-Defined)
        {"generalized_coordinate_deviation",   [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_coordinate_value",       [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_speed_deviation",        [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_speed_value",            [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_acceleration_deviation", [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_acceleration_value",     [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_position_deviation",          [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_position_value",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_velocity_deviation",          [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_velocity_value",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"body_orientation_deviation",         [1, 1, 1], [1, 1, 1, 1]}, ...
        {"body_orientation_value",             [1, 1, 1], [1, 1, 1, 1]}, ...
        {"kinetic_consistency",                [1, 1, 1], [1, 1, 1, 0]}, ...
        {"root_segment_residual_load",         [1, 1, 1], [1, 1, 1, 1]}, ...
        {"external_force_deviation",           [1, 1, 1], [1, 1, 1, 1]}, ...
        {"external_force_value",               [1, 1, 1], [1, 1, 1, 1]}, ...
        {"external_moment_deviation",          [1, 1, 1], [1, 1, 1, 1]}, ...
        {"external_moment_value",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"center_of_pressure_deviation",       [1, 0, 1], [1, 1, 1, 1]}, ...
        {"center_of_pressure_deviation",       [1, 0, 1], [1, 1, 1, 1]}, ...
        {"limit_muscle_activation",            [0, 0, 1], [0, 1, 1, 0]}, ...
        {"limit_normalized_fiber_length",      [0, 0, 1], [0, 1, 1, 0]}, ...
        {"user_defined",                       [1, 1, 1], [1, 1, 1, 1]}, ...
    };
...
elseif strcmp(constraintTermType, "terminal")
    constraintTermSet = { ...
        % Table with the columns:
        % Name, Supported Tools (TO, VO, DO), Supported Controllers (Torque, Synergy, Muscle, User-defined)
        {"generalized_coordinate_periodicity",       [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_generalized_coordinate_deviation", [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_generalized_coordinate_value",     [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_generalized_coordinate_deviation",   [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_generalized_coordinate_value",       [1, 1, 1], [1, 1, 1, 1]}, ...
        {"generalized_speed_periodicity",            [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_generalized_speed_deviation",      [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_generalized_speed_value",          [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_generalized_speed_deviation",        [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_generalized_speed_value",            [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_position_periodicity",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_marker_position_deviation",        [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_marker_position_value",            [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_marker_position_deviation",          [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_marker_position_value",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"marker_velocity_periodicity",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_marker_velocity_deviation",        [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_marker_velocity_value",            [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_marker_velocity_deviation",          [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_marker_velocity_value",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"body_orientation_periodicity",             [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_body_orientation_deviation",       [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_body_orientation_value",           [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_body_orientation_deviation",         [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_body_orientation_value",             [1, 1, 1], [1, 1, 1, 1]}, ...
        {"root_segment_residual_load_periodicity",   [1, 1, 1], [1, 1, 1, 1]}, ...
        {"external_force_periodicity",               [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_external_force_deviation",         [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_external_force_value",             [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_external_force_deviation",           [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_external_force_value",               [1, 1, 1], [1, 1, 1, 1]}, ...
        {"external_moment_periodicity",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_external_moment_deviation",        [1, 1, 1], [1, 1, 1, 1]}, ...
        {"initial_external_moment_value",            [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_external_moment_deviation",          [1, 1, 1], [1, 1, 1, 1]}, ...
        {"final_external_moment_value",              [1, 1, 1], [1, 1, 1, 1]}, ...
        {"synergy_vector_sum",                       [1, 0, 1], [0, 1, 0, 0]}, ...
        {"synergy_vector_magnitude",                 [1, 0, 1], [0, 1, 0, 0]}, ...
        {"user_defined",                             [1, 1, 1], [1, 1, 1, 1]}, ...
    };
