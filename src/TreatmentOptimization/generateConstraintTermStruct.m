...
if strcmp(constraintTermType, "path")
    constraintTermSet = { ...
        ...
        {"INTERNAL_activation_dynamics",       [1, 1, 1], [0, 1, 1, 0], 0}, ...
    };
...
constraintTermCalculations.INTERNAL_activation_dynamics = @(values, modeledValues, auxdata, constraintTerm) ...
    calcInternalActivationDynamicsConstraint(values, ...
    modeledValues, ...
    auxdata, ...
    constraintTerm);
end
