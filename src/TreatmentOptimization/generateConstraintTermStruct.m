...
constraintTermCalculations.generalized_coordinate_symmetry = @(values, modeledValues, auxdata, constraintTerm) ...
...
constraintTermCalculations.generalized_speed_symmetry = @(values, modeledValues, auxdata, constraintTerm) ...
...
constraintTermCalculations.generalized_acceleration_symmetry = @(values, modeledValues, auxdata, constraintTerm) ...
...
constraintTermCalculations.controller_symmetry = @(values, modeledValues, auxdata, constraintTerm) ...
