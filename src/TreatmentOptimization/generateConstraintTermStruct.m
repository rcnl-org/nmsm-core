        ...
        case "TrackingOptimization"
            if strcmp(constraintTermType, "path")
                allowedTypes = [ ...
                    ...
                    "controller_periodicity", ...
                    "generalized_coordinate_smoothing", ...
                    "generalized_speed_smoothing", ...
                    "generalized_acceleration_smoothing", ...
                    "controller_smoothing", ...
                    ];
            end
...
constraintTermCalculations.generalized_coordinate_symmetry = @(values, modeledValues, auxdata, constraintTerm) ...
    calcGeneralizedCoordinateSymmetryPathConstraint( ...
    constraintTerm, ...
    auxdata, ...
    values.time, ...
    values.positions, ...
    constraintTerm.base_coordinate, ...
    constraintTerm.shifted_coordinate ...
    );

constraintTermCalculations.controller_periodicity = @(values, modeledValues, auxdata, constraintTerm) ...
    calcControllerPeriodicityPathConstraint( ...
    auxdata, ...
    values, ...
...
constraintTermCalculations.controller_symmetry = @(values, modeledValues, auxdata, constraintTerm) ...
    ...
    values.time, ...
    values, ...
    constraintTerm.base_controller, ...
    constraintTerm.shifted_controller ...
	);
	
constraintTermCalculations.generalized_coordinate_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcGeneralizedCoordinateSmoothingPathConstraint( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    values.positions, ...
...
constraintTermCalculations.generalized_speed_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcGeneralizedSpeedSmoothingPathConstraint( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    values.velocities, ...
...
constraintTermCalculations.generalized_acceleration_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcGeneralizedAccelerationSmoothingPathConstraint( ...
    costTerm, ...
    auxdata, ...
    values.time, ...
    values.accelerations, ...
...
constraintTermCalculations.controller_smoothing = @(values, modeledValues, auxdata, costTerm) ...
    calcControllerSmoothingPathConstraint( ...
    costTerm, ...
    auxdata, ...
    values, ...
    values.time, ...
