...
if strcmp(constraintTermType, "path")
    constraintTermSet = { ...
        ...
        % (Torque, Synergy, Muscle), AD support
        ...
        {"marker_position_deviation",          [1, 1, 1], [1, 1, 1], 0}, ...
        {"marker_position_value",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"marker_velocity_deviation",          [1, 1, 1], [1, 1, 1], 0}, ...
        {"marker_velocity_value",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"body_orientation_deviation",         [1, 1, 1], [1, 1, 1], 0}, ...
        {"body_orientation_value",             [1, 1, 1], [1, 1, 1], 0}, ...
        {"kinetic_consistency",                [1, 1, 1], [1, 1, 1], 0}, ...
        {"root_segment_residual_load",         [1, 1, 1], [1, 1, 1], 0}, ...
        {"external_force_deviation",           [1, 1, 1], [1, 1, 1], 0}, ...
        {"external_force_value",               [1, 1, 1], [1, 1, 1], 0}, ...
        {"external_moment_deviation",          [1, 1, 1], [1, 1, 1], 0}, ...
        {"external_moment_value",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"center_of_pressure_deviation",       [1, 0, 1], [1, 1, 1], 0}, ...
        {"center_of_pressure_deviation",       [1, 0, 1], [1, 1, 1], 0}, ...
        {"limit_muscle_activation",            [0, 0, 1], [0, 1, 1], 1}, ...
        {"limit_normalized_fiber_length",      [0, 0, 1], [0, 1, 1], 1}, ...
        {"user_defined",                       [1, 1, 1], [1, 1, 1], 0}, ...
    };
...
elseif strcmp(constraintTermType, "terminal")
    constraintTermSet = { ...
        ...
        {"marker_position_periodicity",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_marker_position_deviation",        [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_marker_position_value",            [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_marker_position_deviation",          [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_marker_position_value",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"marker_velocity_periodicity",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_marker_velocity_deviation",        [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_marker_velocity_value",            [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_marker_velocity_deviation",          [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_marker_velocity_value",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"body_orientation_periodicity",             [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_body_orientation_deviation",       [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_body_orientation_value",           [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_body_orientation_deviation",         [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_body_orientation_value",             [1, 1, 1], [1, 1, 1], 0}, ...
        {"root_segment_residual_load_periodicity",   [1, 1, 1], [1, 1, 1], 0}, ...
        {"external_force_periodicity",               [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_external_force_deviation",         [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_external_force_value",             [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_external_force_deviation",           [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_external_force_value",               [1, 1, 1], [1, 1, 1], 0}, ...
        {"external_moment_periodicity",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_external_moment_deviation",        [1, 1, 1], [1, 1, 1], 0}, ...
        {"initial_external_moment_value",            [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_external_moment_deviation",          [1, 1, 1], [1, 1, 1], 0}, ...
        {"final_external_moment_value",              [1, 1, 1], [1, 1, 1], 0}, ...
        {"synergy_vector_sum",                       [1, 0, 1], [0, 1, 0], 1}, ...
        {"synergy_vector_magnitude",                 [1, 0, 1], [0, 1, 0], 1}, ...
        {"user_defined",                             [1, 1, 1], [1, 1, 1], 0}, ...
    };
