...
if ~isempty(valueOrAlternate(inputs, "torqueControllerCoordinateNames", []))
    ...
    writeToSto(controlLabels, values.time, values.torqueControls, ...
        fullfile(inputs.resultsDirectory, ...
...
writeToSto(inputs.inverseDynamicsMomentLabels, values.time, ...
    solution.inverseDynamicsMoments, fullfile(outputDirectory, "IDData", ...
