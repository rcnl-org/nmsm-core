...
if inputs.useGroundReactionControls
    [time, groundReactions] = splineToEvenlySpaced(values.time, ...
        values.controlGroundReactions, length(inputs.experimentalTime));
    writeToSto(inputs.initialGroundReactionControlLabels, time, groundReactions, ...
        fullfile(inputs.resultsDirectory, strcat(inputs.trialName, "_controlGroundReactions.sto")));
end
