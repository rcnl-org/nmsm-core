...
if any(inputs.controllerTypes(2:3))
    ...
    if inputs.useActivationDynamics
        [time, excitations] = splineToEvenlySpaced(values.time, ...
            values.excitationControls, length(inputs.experimentalTime));
        writeToSto(inputs.muscleLabels, time, ...
            excitations, fullfile(inputs.resultsDirectory, ...
            strcat(inputs.trialName, "_combinedExcitations.sto")));
    end
end
