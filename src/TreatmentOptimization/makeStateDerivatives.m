...
if isfield(inputs, "trackedStateVelocities") && ...
        isfield(inputs, "trackedStateAccelerations")
    [~, stateIndices, ~] = intersect(inputs.coordinateNames, ...
        inputs.trackedStateNames);
    inputs.experimentalJointVelocities(:, stateIndices) = ...
        inputs.trackedStateVelocities;
    inputs.experimentalJointAccelerations(:, stateIndices) = ...
        inputs.trackedStateAccelerations;
end
if inputs.useJerk
