...
for i = 1:length(params.contactSurfaces)
    ...
    [groundReactions.parentForces{i}, groundReactions.parentMoments{i}] = ...
        calcGroundReactionForcesAndMoments( ...
            springPositions.parent{i}, ...
            springVelocities.parent{i}, ...
            contactSurface.parentSpringConstants, ...
            bodyLocations.midfootSuperior{i}, ...
            contactSurface, contactSurface.parentSpringIndices); 

    [groundReactions.childForces{i}, groundReactions.childMoments{i}] = ...
        calcGroundReactionForcesAndMoments( ...
            springPositions.child{i}, ...
            springVelocities.child{i}, ...
            contactSurface.childSpringConstants, ...
            bodyLocations.midfootSuperior{i}, ...
            contactSurface, contactSurface.childSpringIndices);    %
end
end
...
for i = 1:nFrames
    ...
    % % -----nmsm---------------
    markerKinematics_nmsm.xPosition = squeeze(markerPositions(i, 1, :))';
    markerKinematics_nmsm.height = squeeze(markerPositions(i, 2, :))';
    markerKinematics_nmsm.zPosition = squeeze(markerPositions(i, 3, :))';
    markerKinematics_nmsm.xVelocity = squeeze(markerVelocities(i, 1, :))';
    markerKinematics_nmsm.yVelocity = squeeze(markerVelocities(i, 2, :))';
    markerKinematics_nmsm.zVelocity = squeeze(markerVelocities(i, 3, :))';

    matrix = [markerKinematics.xPosition;
    ...
    matrix_nmsm = [markerKinematics_nmsm.xPosition;
          markerKinematics_nmsm.height;
          markerKinematics_nmsm.zPosition;
          markerKinematics_nmsm.xVelocity;
          markerKinematics_nmsm.yVelocity;
          markerKinematics_nmsm.zVelocity];  
...
matrix_diff = matrix-matrix_nmsm;
end
