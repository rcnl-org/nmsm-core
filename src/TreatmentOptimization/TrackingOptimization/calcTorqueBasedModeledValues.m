...
% The 'sum' function is used to ensure the function gets the logical
% arguments as doubles for compatibility with MEX functions. 
[modeledValues.inverseDynamicsMoments, modeledValues.angularMomentum, ....
    ~, massCenterPositons, ...
    modeledValues.bodyOrientations, ...
    modeledValues.bodyAngularVelocities, modeledValues.imuQuantities] = ...
    ...
    inputs.trackedAngularVelocityIndices, ...
    inputs.trackedImuBodyIndices, ...
    inputs.trackedImuLocations, ...
    sum(valueOrAlternate(inputs, 'calculateAngularMomentum', false)), ...
    false, sum(valueOrAlternate(inputs, 'calculateBodyOrientation', ...
    false)), sum(valueOrAlternate(inputs, 'calculateBodyAngularVelocity', ...
    false)), sum(valueOrAlternate(inputs, 'calculateImuQuantities', ...
