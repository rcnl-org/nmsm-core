...
[appliedLoads, modeledValues.groundReactionsLab, ...
    modeledValues.groundReactionsBody] = setupAppliedLoads(values, ...
...
function [appliedLoads, groundReactionsLab, groundReactionsBody] = ...
    setupAppliedLoads(values, inputs, modeledValues, springPositions, ...
    springVelocities)
appliedLoads = [];
...
if ~isempty(inputs.contactSurfaces)
    ...
    if inputs.useGroundReactionControls
        appliedLoads = [appliedLoads values.controlGroundReactions];
    else
