...
% 
% Calculates deviation in initial marker velocity. 
...
function [constraintValue, constraintTerm] = ...
    calcInitialMarkerVelocityDeviation(constraintTerm, inputs, ...
...
constraintValue = velocities(1) - experimentalVelocities(1);
end
