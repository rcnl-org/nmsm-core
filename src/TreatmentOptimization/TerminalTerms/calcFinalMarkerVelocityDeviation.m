...
% 
% Calculates deviation in final marker velocity. 
...
function [constraintValue, constraintTerm] = ...
    calcFinalMarkerVelocityDeviation(constraintTerm, inputs, ...
...
constraintValue = velocities(end) - experimentalVelocities(end);
end
