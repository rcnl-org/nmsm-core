...
% 
% Calculates deviation in final marker position. 
...
function [constraintValue, constraintTerm] = ...
    calcFinalMarkerPositionDeviation(constraintTerm, inputs, ...
...
experimentalPositions = applyTermOffset(constraintTerm, ...
...
constraintValue = positions(end) - experimentalPositions(end);
end
