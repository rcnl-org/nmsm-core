...
expandEmgDatas(inputs.model, inputs.emgFileName, ...
    fullfile(inputs.resultsDir, emgResultsDir), ...
    fullfile(inputs.resultsDir, maResultsDir, inputs.prefix + ...
    "_Length.sto"), inputs.prefix, params);
filesToSection = [ ...
    fullfile(inputs.resultsDir, ikResultsDir, inputs.prefix + ".mot"), ...
